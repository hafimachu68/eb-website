        ...
        <Carousel.Item>
          <Card className="wbg ">
            <Card.Body className='wcbm'>
              ...
              <Card.Img className='mwbmg' src={bimage1} alt="First slide" />
            </Card.Body>
          </Card>
        </Carousel.Item>
        <Carousel.Item>
          <Card className="wbg ">
            <Card.Body className='wcbm'>
              ...
              <Card.Img className='mwbmg' src={bimage2} alt="First slide" />
            </Card.Body>
          </Card>
        </Carousel.Item>
        <Carousel.Item>
          <Card className="wbg ">
            <Card.Body className='wcbm'>
              ...
              <Card.Img className='mwbmg' src={bimage3} alt="First slide" />
            </Card.Body>
          </Card>
        </Carousel.Item>
        <Carousel.Item>
          <Card className="wbg ">
            <Card.Body className='wcbm'>
              ...
              <Card.Img className='mwbmg' src={bimage4} alt="First slide" />
            </Card.Body>
          </Card>
        </Carousel.Item>
        <Carousel.Item>
          <Card className="wbg ">
            <Card.Body className='wcbm'>
              ...
              <Card.Img className='mwbmg' src={bimage5} alt="First slide" />
            </Card.Body>
          </Card>
        </Carousel.Item>
      </Carousel>
