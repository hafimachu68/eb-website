      ...
      <Slider {...settings}>
        <div className="cslide">
          <div className="slideinside">
            ...
            <p className="cntrpp">
              A cutting-edge attendance management solution designed with the efficiency and simplicity in mind. Whether you're a small business, educational institution, or large corporation, this solution empowers you to effortlessly monitor attendance, streamline administrative tasks, and enhance productivity.
            </p>
            <div className="row align-items-center">
              <div className="col cntrb">
                <button className="btn cntrbtn">
                  <a href="/Usecase1" target="_blank" rel="noopener noreferrer" style={{ color: 'inherit', textDecoration: 'none' }}>
                    Explore
                  </a>
                </button>
              </div>
        ...
        <div className="cslide">
          <div className="slideinside">
            ...
            <div className="row align-items-center">
              <div className="col cntrb">
                <button className="btn cntrbtn">
                  <a href="/Usecase2" target="_blank" rel="oopener noreferrer" style={{ color: 'inherit', textDecoration: 'none' }}>
                    Explore
                  </a>
                </button>
              </div>
        ...
        <div className="cslide">
          <div className="slideinside">
            ...
            <div className="row align-items-center">
              <div className="col cntrb">
                <button className="btn cntrbtn" style={{ opacity: 0.5, pointerEvents: 'none', cursor: 'not-allowed' }}>
                  <a href="https://example.com/quotation-management" target="_blank" rel="noopener noreferrer" style={{ color: 'inherit', textDecoration: 'none' }}>
                    Explore
                  </a>
                </button>
              </div>
        ...
        <div className="cslide">
          <div className="slideinside">
            ...
            <div className="row align-items-center">
              <div className="col cntrb">
                <button className="btn cntrbtn">
                  <a href="/Usecase3" target="_blank" rel="noopener noreferrer" style={{ color: 'inherit', textDecoration: 'none' }}>
                    Explore
                  </a>
                </button>
              </div>
