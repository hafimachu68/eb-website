          ...
          <Carousel>
            ...
            <Carousel.Item>
              ...
              <Card.Body>
                <Row>
                    <Col>
                      <img  src={documents} alt="Documents Forms Icon" className="icon" /> {/* Web Forms Icon */}
                    </Col>
                    <Col className="text-center align-self-center">
            ...
            <Carousel.Item>
              ...
              <Card.Body>
                <Row>
                    <Col>
                      <img  src={api} alt="APIs Forms Icon" className="icon" /> {/* Web Forms Icon */}
                    </Col>
                    <Col className="text-center align-self-center">
            ...
            <Carousel.Item>
              ...
              <Card.Body>
                <Row>
                    <Col>
                      <img  src={mobapp} alt="Mobile Apps Forms Icon" className="icon" /> {/* Web Forms Icon */}
                    </Col>
                    <Col className="text-center align-self-center">
                  ...
                  <div className="carousel-content pt-5">
                        ...
                        <h5 className='mmh'>Empower Your fast growing business with Internal Mobile Appsr</h5>
